      ...
      <main className="max-w-[1200px] mx-auto px-4 md:px-6 mt-16 mb-24">
        {loading ? (
          ...
          <article className="prose prose-slate prose-lg max-w-none">
            <h1 className="text-4xl font-extrabold text-[#ee4d2d] mb-8 tracking-tight border-b pb-4">Contact Us</h1>
            <div className="space-y-6 text-[#4a4a4a] leading-relaxed">
              ...
              <h2 className="text-2xl font-bold text-[#ee4d2d] mt-8 mb-4">Our Contact Information</h2>
