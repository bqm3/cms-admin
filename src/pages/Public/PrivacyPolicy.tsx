      ...
      <main className="max-w-[1200px] mx-auto px-4 md:px-6 mt-16 mb-24">
        {loading ? (
          ...
          <article className="prose prose-slate prose-lg max-w-none">
            <h1 className="text-4xl font-extrabold text-[#ee4d2d] mb-8 tracking-tight border-b pb-4">Privacy Policy</h1>
            <div className="space-y-6 text-[#4a4a4a] leading-relaxed">
              <h2 className="text-2xl font-bold text-[#ee4d2d] mt-8 mb-4">Statement Information User</h2>
              <p>While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you. Web servers (the computers that "serve up" Web pages) automatically identify your computer by its IP address; when you request a page from couponzas.com, our servers log your IP address. We collect this information for the purpose of providing the Service and Web traffic analysis and trend.</p>

              <h2 className="text-2xl font-bold text-[#ee4d2d] mt-8 mb-4">Log Files</h2>
              ...
              <h2 className="text-2xl font-bold text-[#ee4d2d] mt-8 mb-4">Cookies</h2>
              ...
              <h2 className="text-2xl font-bold text-[#ee4d2d] mt-8 mb-4">Links To Other Sites</h2>
              ...
              <h2 className="text-2xl font-bold text-[#ee4d2d] mt-8 mb-4">Third Party Company Service Provider</h2>
              ...
              <h2 className="text-2xl font-bold text-[#ee4d2d] mt-8 mb-4">Affiliates</h2>
              ...
              <h2 className="text-2xl font-bold text-[#ee4d2d] mt-8 mb-4">Individuals under 13</h2>
              <p>No information should be submitted on couponzas.com by users under the age of 13 years without consent of their parent or guardian. couponzas.com does not provide any personally-identifying information for users under the age of 13, regardless of its source, to any third party for any purpose whatsoever unless disclosed during collection. We encourage parents and legal guardians to monitor their children's Internet usage and to help enforce our Privacy Policy by instructing their children never to provide Personal Information to us without their parent's or legal guardian's permission.</p>

              <h2 className="text-2xl font-bold text-[#ee4d2d] mt-8 mb-4">International Transfer</h2>
