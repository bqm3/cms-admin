...
export const SliderComponent = ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={`w-full flex flex-col ${alignClass}`}
          style={{
        ...
        >
          ...
          {!!cur?.ctaText && (
            <div
              className={`flex gap-2 ${contentAlign === "center" ? "justify-center" : "justify-start"}`}
            >
              <a
                href={cur?.ctaHref || "#"}
                target="_blank"
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-2 gap-2">
        ...
        <Input
          ...
          size="sm"
          variant="bordered"
          value={overlay || "rgba(0,0,0,.45)"}
          onChange={(e) => setProp((p: any) => (p.overlay = e.target.value))}
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        <label className="flex items-center gap-2 text-sm">
          <input
            ...
            checked={!!autoPlay}
            onChange={(e) =>
              setProp((p: any) => (p.autoPlay = e.target.checked))
            }
          />
          Auto play
        </label>
        ...
        <Input
          ...
          onChange={(e) =>
            setProp((p: any) => (p.intervalMs = Number(e.target.value || 4000)))
          }
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        ...
        <Input
          ...
          onChange={(e) =>
            setProp((p: any) => (p.maxContentWidth = e.target.value))
          }
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        <Input
          ...
          value={paddingX ?? 24}
          onChange={(e) =>
            setProp((p: any) => (p.paddingX = Number(e.target.value || 0)))
          }
        />
        <Input
          label="Padding Y"
          ...
          value={paddingY ?? 48}
          onChange={(e) =>
            setProp((p: any) => (p.paddingY = Number(e.target.value || 0)))
          }
        />
      </div>
      ...
      <div className="grid grid-cols-2 gap-2">
        <Input
          ...
          size="sm"
          variant="bordered"
          value={titleColor || "rgba(255,255,255,.95)"}
        ...
        <Input
          ...
          size="sm"
          variant="bordered"
          value={subtitleColor || "rgba(255,255,255,.75)"}
          onChange={(e) =>
            setProp((p: any) => (p.subtitleColor = e.target.value))
          }
        />
      </div>
      ...
      <div className="pt-2">
        ...
        <div className="space-y-2 mt-2">
          {(slides || []).map((s: any, idx: number) => (
            <div
              key={idx}
              className="p-3 rounded-xl bg-zinc-900 border border-white/10 space-y-2"
            >
