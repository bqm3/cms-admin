...
const devServerTarget =
  ...
  process.env.DEV_SERVER_TARGET || 'https://dev-gvn.cdsdservice.com/';
    ...
    proxy: [
      {
        ...
        headers: {
          ...
          Referer: 'https://dev-gvn.cdsdservice.com/',
        },
      },
      {
        context: '/superset-proxy/',
        target: 'https://dev-dash.cdsdservice.com',
        pathRewrite: { '^/superset-proxy': '' },
        changeOrigin: true,
        secure: false,
        headers: {
          Origin: 'https://dev-dash.cdsdservice.com',
          Referer: 'https://dev-dash.cdsdservice.com/',
        },
      },
    ],
  },
